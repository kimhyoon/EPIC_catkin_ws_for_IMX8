...
class PositionCommand {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('acc_norm')) {
        this.acc_norm = initObj.acc_norm
      }
      else {
        this.acc_norm = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [acc_norm]
    bufferOffset = _serializer.float64(obj.acc_norm, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [acc_norm]
    data.acc_norm = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.acc_norm !== undefined) {
      resolved.acc_norm = msg.acc_norm;
    }
    else {
      resolved.acc_norm = 0.0
    }
